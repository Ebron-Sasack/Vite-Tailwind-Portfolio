            ...
            >
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            ...
                            <div className="space-y-6 justify-center">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:ebronsasack3@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                                            ebronsasack3@gmail.com
                                        </a>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+919042486672" className="text-muted-foreground hover:text-primary transition-colors">
                                            +91 9042486672
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSumit}>
